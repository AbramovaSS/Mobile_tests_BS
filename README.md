...
Для выбора параметров (например, окружения, браузера, версии браузера и т.д.) и запуска [сборки в Jenkins](https://jenkins.autotests.cloud/view/java_students/job/AbramovaS_Mobile_autotests_for_Wikipedia/) необходимо нажать <kbd>Build with Parameters</kbd>.
...
Увидеть результаты автотестов можно в интерактивном [Allure-отчёте](https://jenkins.autotests.cloud/view/java_students/job/AbramovaS_Mobile_autotests_for_Wikipedia/27/allure/) — с детальными скриншотами, логами, видео и историей запусков. 
...
сборки в [TestOps](https://allure.autotests.cloud/launch/53221), где можно отслеживать историю запусков, анализировать прогоны, управлять тест-кейсами, дефектами и требованиями в одном месте. Через общие дашборды
...
В проекте настроена автоматическая отправка данных о сборке из Jenkins в систему управления задачами и проектами - [Jira](https://jira.autotests.cloud/browse/HOMEWORK-1607). В результате в задачах Jira появляются:
